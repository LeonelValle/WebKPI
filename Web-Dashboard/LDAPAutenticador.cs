...
namespace Web_Dashboard
{
    public class LDAPAutenticador
    {
        ...
        static string dominio = "masterworkelectronics.com";
        static string adPath = "LDAP://MEX-AD-001." + dominio;

        public string Dominio { get => dominio; set => dominio = value; }
        public string AdPath { get => adPath; set => adPath = value; }

        public LDAPAutenticador(string path)
        {
            _path = path;
        }
        public LDAPAutenticador()
        {
        }
        ...
        public bool autenticado(string dominio, string usuario, string pass)
        {
            ...
            try
            {
                ...
                //Session["name"] = listaPropiedades[0].ToString();
                _path = result.Path;
