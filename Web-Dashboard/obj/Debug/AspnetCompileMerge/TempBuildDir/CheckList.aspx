...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" id="CheckMain">
        ...
        <div class="ident">
            ...
            <asp:TextBox ID="txt_CommentBackup" runat="server" TextMode="MultiLine"></asp:TextBox>
        ...
        <div class="ident">
            ...
            <asp:TextBox ID="txt_ACfuncionaCom" runat="server" TextMode="MultiLine"></asp:TextBox>
        ...
        <div class="ident">
            ...
            <asp:TextBox ID="txt_AVdeteccionCom" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        <br />
        <hr />
        <br />
        ...
        <div class="ident">
            ...
            <asp:TextBox ID="txt_SalarmaCom" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        <br />
        ...
        <div class="ident">
            ...
            <asp:TextBox ID="txt_NASCom" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        <br />
        <br />
        ...
        <div class="ident">
            ...
            <asp:TextBox ID="txt_CommentSwitch" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        <br />
        ...
        <div class="ident">
            ...
            <asp:TextBox ID="txt_CommentOtroDisp" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        ...
        <div class="ident">
            <asp:Label runat="server" Text="Comments:"></asp:Label>
            <asp:TextBox ID="txt_CommentTelefono" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        <br />
        ...
        <div class="ident">
            <asp:Label runat="server" Text="Comments:"></asp:Label>
            <asp:TextBox ID="txt_CommentInternet" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        ...
        <div class="ident">
            ...
            <asp:TextBox ID="txt_CommentPTRG" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        ...
        <div class="ident">
            ...
            <asp:TextBox ID="txt_CommentWIFI" runat="server" TextMode="MultiLine"></asp:TextBox>
        </div>
        <br />
        <hr />
        <br />
