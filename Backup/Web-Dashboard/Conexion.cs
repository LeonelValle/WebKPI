...
namespace Web_Dashboard
{
    public class Conexion
    {
        ...
        //RESPARLDO
        Con1 = new SqlConnection(@"Data Source=192.168.1.4\SQLEXPRESS;Initial Catalog=dashboard;User ID=admin;Password=mbettaglo;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        ...
        public DataSet LlenarDG(string Comando) // Metodo para Ejecutar Comandos
        {
            ...
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommandText: Comando, selectConnection: Con1);
            using (SqlDataAdapter CMD = sqlDataAdapter) // Creamos un DataAdapter con el Comando y la Conexion
            {
                DS.Dispose();
        ...
        public DataView Leer_Datos(string query, string tabla)
        {
            ...
            if (tabla.Contains("tb_Historial") == false)
                ...
                return ((DataTable)res.Tables["tb_Historial.id_modeloOrden, tb_Historial.scanmac, tb_Historial.scanimei , tb_Historial.fecharegistro, tb_Historial.id_orden,  tb_Historial.fechaCambio, tb_Orden.orden, tb_caja.caja, tb_Ensamble.ensamble, tb_Operador.operador"]).DefaultView;
